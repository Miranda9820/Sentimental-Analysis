...
if df_results is not None and not df_results.empty:
    ...
    sentiment_colors = ['#e74c3c', '#f1c40f', '#2ecc71']
    sns.countplot(x='sentiment', data=df_results, order=sentiment_order, palette=sentiment_colors, ax=ax)
    ax.set_xlabel('Sentiment')
    ax.set_ylabel('Count')
    ax.set_title('Number of Each Sentiment')
